...
input_metadata_dir = config['directories']['input_definitions_dir']
output_metadata_dir = config['directories']['output_definitions_dir']
input_patched_roms_dir = config['directories']['input_patched_roms_dir']
output_patched_roms_dir = config['directories']['output_patched_roms_dir']
user_roms_dir = config['directories']['user_roms_dir']
user_roms_output_dir = config['directories']['user_roms_output_dir']
...
for filename in os.listdir(user_roms_dir):
    # Open rom to migrate
    with open(os.path.join(user_roms_dir, filename), "rb") as binaryfile:
        modified_data = bytearray(binaryfile.read())

    # Find input and output definitions
    print("Migrating user ROM: {}".format(filename))
    ...
    # Write output file
    output_file = open(os.path.join(user_roms_output_dir, filename), "wb")
